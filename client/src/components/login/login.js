         ...
         <div className="login-background container-fluid">
            ...
            <form className="login-form-container row" onSubmit={handleSubmit(this.handleLogin)}>
               <div className="login-input-padding ">
                  <Field name="email" label="E-mail" component={Input} inputClassName="login-user-input col-8" labelClassName="label-login-color" loginActive="login-active" />
               </div>
               <div className="login-input-padding ">
                  <Field name="password" label="Password" component={Input} type="password" inputClassName="login-user-input col-8" labelClassName="label-login-color" loginActive="login-active"/>
               </div>
